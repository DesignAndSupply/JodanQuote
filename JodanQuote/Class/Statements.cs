...
namespace Statements
{
    class Statementsclass
    {
      ...
      //               "[Jamb Style], addon_cost, item_notes, converted_cost, infill_id, [Infill Description] 
        ...
        public static string insert_copied_item = "Insert into dbo.item (project_id,item_id ,order_id , item_date ,material_id,finish_id,fire_rating_id,security_rating_id,infill_id,jamb_style_id,item_notes,door_ref ,door_type_id, door_style, structual_op_height, structual_op_width, frame_width, frame_height,jamb_width,jamb_height,finish_description,finish_colour,material_thickness,created_by,revision_id,markup_material,material_cost,markup_hardware,hardware_cost,labour_rate,labour_cost,fire_rating_cost,security_rating_cost,paint_cost,addon_cost,converted_cost,total_cost) " +
                                                  "Values (@project_id,@item_id,@order_id ,@item_date ,@material_id,@finish_id,@fire_rating_id,@security_rating_id,@infill_id,@jamb_style_id, @item_notes,@door_ref ,@door_type, @door_style, @structual_op_height, @structual_op_width, @frame_width, @frame_height,@jamb_width,@jamb_height,@finish_description,@finish_colour,@material_thickness, @created_by,1,@markup_material,@material_cost,@markup_hardware,@hardware_cost,@labour_rate,@labour_cost,@fire_rating_cost,@security_rating_cost,@paint_cost,@addon_cost,@converted_cost,@total_cost)";
