...
namespace Statements
{
    class Statementsclass
    {
        ...
        public static string select_quote_item_count = "SELECT [Project ID], [Number Of Items],[Date Created],[Total Value] From C_view_item_count ";
        ...
        public static string update_quotation_item = "Update dbo.item SET structual_op_height = @structure_height, structual_op_width = @structure_width," +
                                                     "frame_height = @frame_height, frame_width = @frame_width , door_type = @door_type, finish_id = @finish_id,material_id = @material_id, material_thickness = @material_thickness," +
